...
from tests.store import Base, User, Scheme, Membership, LedgerEntry, AuditEvent
...
def create_app(database_url, demo_mode):
    # Fixture databases are explicit; never inherit a deployment database URL.
    demo = demo_mode
    ...
    def home():
        return RedirectResponse(frontend_origin(), status_code=307)
