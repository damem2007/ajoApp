...
from app.config import database_url as configured_database_url, frontend_origin as configured_frontend_origin, sandbox_enabled, cors_origins
...
def create_platform(database_url=None,sandbox=None):
    sandbox=sandbox_enabled() if sandbox is None else sandbox
    ...
    async def headers(request,call_next):
        ...
        frontend_origin=configured_frontend_origin()
